...
These are the core smoke tests implemented inline. The **full contract test suite** (401 tests) is documented in [`CONTRACT_TESTS.md`](../multi-db/CONTRACT_TESTS.md) — a standalone spec for implementation developers building compatible servers in any language.
